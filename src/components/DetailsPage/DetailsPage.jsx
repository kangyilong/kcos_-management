...
export default function DetailsPage(props) {
    ...
    return (<div className={styles.details_page}>
      {detailsData.length > 0 && detailsData.map((item, index) => (<Row key={index} className={styles.details_row}>
...
//# sourceMappingURL=DetailsPage.jsx.map