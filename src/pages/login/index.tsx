...
class LoginIndex extends PureComponent<Props, any> {
    ...
    handleSubmit = (e: any) => {
        ...
        this.props.form.validateFields((err: any, values: any) => {
            if (!err) {
                ...
                wantOperationApi({statements}).then((data: any) => {
...
const WrappedNormalLoginForm = Form.create({ name: 'normal_login' })<any>(LoginIndex);
